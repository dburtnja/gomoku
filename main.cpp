...
//    SingleStone * testStone = new SingleStone(SECOND_PLAYER, 10, 10);
//    SingleStone * testStone1 = new SingleStone(FIRST_PLAYER, 9, 10);
//
//    ArtificialIntelligence * AI = new ArtificialIntelligence;
//    mainBoard->availablespots.push_back(new AvailableSpot(1,1));
////    mainBoard->putStoneOnBoard(1,1,2);
////    mainBoard->putStoneOnBoard(0,0,2);
////    mainBoard->putStoneOnBoard(1,2,1);
////    mainBoard->putStoneOnBoard(2,1,2);
////    mainBoard->putStoneOnBoard(0,2,1);
//
//
////    mainBoard->putStoneOnBoard(0,2,2);
////    mainBoard->putStoneOnBoard(0,3,1);
////    mainBoard->putStoneOnBoard(3,3,2);
